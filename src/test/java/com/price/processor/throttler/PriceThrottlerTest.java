...
public class PriceThrottlerTest
{
    ...
    public void eventShouldBeDistributedToListeners()
    {
        ...
        // Assert
        assertEquals(prices.size(), firstListener.getProcessedPrices().size(), "First listener assertion");
        assertEquals(prices.size(), secondListener.getProcessedPrices().size(), "Second listener assertion");
    }
    ...
    public void theLastPriceShouldBeProcessed()
    {
        ...
        // Assert
        assertEquals(8.28d, actual, 0.01);
    }
    ...
    public void theTwoProcessorsShouldNotBlockEachOther()
    {
        ...
        // Assert
        assertTrue(fastListener.getProcessedPrices().size() > slowListener.getProcessedPrices().size(),
                "Fast listener assertion");
    }
